...
// https://www.codeproject.com/Articles/14274/Horizontal-ListView-Component
namespace Widget
{
	/// <summary>
	...
	public class HListView : System.Windows.Forms.UserControl
	{
        ...
        public void Add(string url, string text)
        {
            using (System.Net.WebClient webClient = new System.Net.WebClient())
            {
                ...
                {
                    ilistImages.Images.Add(Image.FromStream(stream));
                }
            }
        ...
        */
        ...
        private void InitializeComponent()
		{
            ...
            this.lvImages.MouseDoubleClick += new System.Windows.Forms.MouseEventHandler(this.OnMouseDoubleClick);
            // 
            // chText
            // 
        ...
        {
            EventHandler<EventArgs> handler = MouseDoubleClick;
            if (handler != null)
